...
describe('Stacks', () => {
  testStackFunctionality('ArrayStack', () => new ArrayStack());
  testStackFunctionality('MapStack', () => new MapStack());
});

function testStackFunctionality(name: string, ctor: () => IStack): void {
  describe(name, () => {
    let stack: IStack;
