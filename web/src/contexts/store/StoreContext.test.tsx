...
describe('AuthContext', () => {
  ...
  const mockData: StoreData = {
    ...
    workspaces: {
      ...
      '11': {
        ...
        name: 'Company',
        tasks: [
          { id: 0, title: 'Task 1', status: 'Todo', description: '', order: 0 },
          { id: 1, title: 'Task 2', status: 'Todo', description: '', order: 1 },
        ],
      },
    },
  };
  ...
  describe('actions/reducers', () => {
    ...
    test('loadTasks([...], _personal)', () => {
      const newTasks: Task[] = [
        { id: 0, title: 'New Task 1', status: 'Todo', description: '', order: 0 },
        { id: 1, title: 'New Task 2', status: 'Todo', description: '', order: 1 },
      ];
